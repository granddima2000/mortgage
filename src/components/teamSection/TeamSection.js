          ...
          <div className={styles.underWrapper}>
            ...
            <div className={styles.skillsWrapper}>
              ...
              <div className={styles.skillsItem}>
                ...
                <div className={styles.skillsDescr}>Find the right way</div>
              </div>
              <div className={styles.skillsItem}>
                <div className={styles.skillsImg}>
                  <img src={dataBase} alt="dataBase" />
                </div>
                <div className={styles.skillsDescr}>Mortgage «database»</div>
              </div>
              <div className={styles.skillsItem}>
                <div className={styles.skillsImg}>
          ...
          <div className={styles.underWrapper}>
            ...
            <div className={styles.skillsWrapper}>
              ...
              <div className={styles.skillsItem}>
                ...
                <div className={styles.skillsDescr}>Perfect place searcher</div>
              </div>
              <div className={styles.skillsItem}>
                <div className={styles.skillsImg}>
              ...
              <div className={styles.skillsItem}>
                ...
                <div className={styles.skillsDescr}>Communication Guru</div>
              </div>
            </div>
          </div>
        </div>
